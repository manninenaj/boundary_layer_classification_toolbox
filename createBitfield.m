function [ bitfield ] = createBitfield(th,time,beta,...
    aero_top,flux,epsilon,shear_vector,sun_rise_set,fubarfield )
%createBitfield creates a bitfield for boundary layer
%classification
